...
export async function GET() {
  ...
  const { data: proposal, error: proposalError } = await supabase
    ...
    .insert({
      ...
      payment_conditions: [
        {
          label: "À vista",
          description: "R$ 8.550,00",
          highlight: true,
          details: "5% de desconto para pagamento integral na aprovação",
        },
        {
          label: "Parcelado 2x",
          description: "2x de R$ 4.500,00",
          highlight: false,
          details: "1ª parcela na aprovação + 2ª parcela em 30 dias",
        },
      ],
  ...
  const items = [
    ...
    {
      title: "Imagem — Praça de Estar",
      description: "Render da praça de estar com paisagismo e mobiliário",
      bu: "3D",
      quantity: 1,
      unit_price: 1100,
      discount_pct: 0,
    ...
    {
      title: "Imagem — Boulevard com Quiosques",
      description: "Render do boulevard com quiosques e circulação",
      bu: "3D",
      quantity: 1,
      unit_price: 1100,
      discount_pct: 0,
